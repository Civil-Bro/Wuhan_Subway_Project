...
class QueryTransferPathPanel extends JPanel {
    private JTextField input1, input2;
    private JTextArea output;
    private final PathFinder pathFinder;
    public QueryTransferPathPanel(PathFinder pathFinder) {
        ...
        JLabel label = new JLabel("查询最短换乘路径 界面", SwingConstants.CENTER);
        topPanel.add(label);
        //input
    ...
    private void onExecute(ActionEvent e) {
        ...
        List segments = PathFinder.getSimplePath(path);
